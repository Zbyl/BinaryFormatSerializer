...
#ifndef BinaryFormatSerializer_IZeroCopySerializer_H
#define BinaryFormatSerializer_IZeroCopySerializer_H
...
#endif // BinaryFormatSerializer_IZeroCopySerializer_H
